  ...
  return (
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl px-6 py-20">
        <ol className="relative border-l hairline pl-8 space-y-16">
          {releases.map((r) => (
            <li key={r.version} className="relative">
              <span className="absolute -left-[37px] top-1.5 size-2.5 rounded-full bg-jade shadow-[0_0_12px_var(--jade)] ring-4 ring-background" />
              <div className="flex items-baseline gap-3 flex-wrap">
                ...
                <span className="text-[11px] font-mono px-2 py-0.5 rounded-full border hairline text-jade">
                  {r.tag}
                </span>
              </div>
        ...
        <p className="mt-20 font-mono text-[11px] text-muted-foreground/70 text-center">
